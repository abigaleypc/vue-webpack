...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = _vue2.default.extend({ store: _store2.default });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  vuex: {
	    actions: { increase: _actions.increase, reset: _actions.reset },
	    getters: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.reset = exports.increase = undefined;

	var _types = __webpack_require__(11);

	var increase = exports.increase = function increase(_ref) {
	    var dispatch = _ref.dispatch;

	    dispatch(_types.INCREASE); // 调用type为INCREASE的mutation
	};

	var reset = exports.reset = function reset(_ref2) {
	    var dispatch = _ref2.dispatch;

	    dispatch(_types.RESET); // 调用type为RESET的mutation
	};
...
/***/ function(module, exports) {
	...
	var INCREASE = exports.INCREASE = 'INCREASE'; // 累加
	var RESET = exports.RESET = 'RESET'; // 清零
...
/***/ function(module, exports, __webpack_require__) {
	...
	_vue2.default.use(_vuex2.default); // 确保在new Vuex.Store()之前
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mutations = (_mutations = {}, (0, _defineProperty3.default)(_mutations, _types.INCREASE, function (state) {
	    state.count++;
	}), (0, _defineProperty3.default)(_mutations, _types.RESET, function (state) {
	    state.count = 0;
	}), _mutations);
